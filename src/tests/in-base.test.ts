...
describe("Assign in base test", () => {
  ...
  it("Should create nested entities with assign in base", async () => {
  ...
  it("should update nested entities with assign in base", async () => {
    await RequestContext.createAsync(orm.em, async () => {
      // let's create the question with options using the create method (this works) to show that the assign, after creation works as expected
      const question = orm.em.create(Question, {
        label: "question label",
        options: [
          {
            label: "option 1",
